...
def im_detect(net, im, boxes=None):
    ...
    for para_name,para in net.params.iteritems():
        print para_name + '\t' + str(para[0].data.shape)+ str(para[1].data.shape)
    ...
    for blob_name,blob in net.blobs.iteritems():
        ...
        try:
            ...
            vis_square(blob.data.reshape(shape_val[0]*shape_val[1],shape_val[2],shape_val[3])[:64],show_type = 'feature')
        except:
            pass
    for para_name,para in net.params.iteritems():
        print para_name + '\t' + str(para[0].data.shape)+ str(para[1].data.shape)
        try:
            ...
            vis_square(para[0].data.reshape(shape_val[0]*shape_val[1],shape_val[2],shape_val[3])[:256],show_type = 'params')
        except:
            pass
    #################################################################################
...
def test_net(net, imdb, max_per_image=100, thresh=0.05, vis=False):
    ...
    imdb._do_python_eval(all_boxes[1], output_dir)
