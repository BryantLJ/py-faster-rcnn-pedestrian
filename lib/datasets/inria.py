...
class inria(imdb):
    def __init__(self,train = 0,test = 0):
        self._name = 'inria'
        self._image_path_root = '/home/bryant/MATLAB-tools/inria/raw_image/'
        self._annotation_path = '/home/bryant/MATLAB-tools/inria/raw_annotations/'
        if train == 1:
            self._image_set = ['set00/']
            self._image_stride = 1# sample 1 frame every 4 frames from _image_set
        else:
            self._image_set = ['set01/']
            self._image_stride = 1# sample 1 frame every 4 frames from _image_set   
